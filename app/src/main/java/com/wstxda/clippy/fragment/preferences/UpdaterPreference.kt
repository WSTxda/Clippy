package com.wstxda.clippy.fragment.preferences
...
import com.wstxda.clippy.services.UpdaterService
...
class UpdaterPreference @JvmOverloads constructor(
    ...
    override fun onBindViewHolder(holder: PreferenceViewHolder) {
        ...
        (holder.findViewById(R.id.version) as? TextView)?.text = getVersionName(context)
